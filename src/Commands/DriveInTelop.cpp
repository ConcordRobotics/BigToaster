...
DriveInTelop::DriveInTelop(int driveModeIn, float topRateIn, int gyroModeIn, float topTwistIn) {
...
void DriveInTelop::Initialize() {
	Robot::driveMotors->SetGyroMode(gyroMode, topTwist);
	Robot::driveMotors->SetDriveMode(driveMode, topRate);
