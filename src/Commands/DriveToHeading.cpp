...
DriveToHeading::DriveToHeading(double headingIn, float maxTwistIn, float maxRateIn, double tolIn) {
...
void DriveToHeading::Initialize() {
	...
	Robot::driveMotors->SetDriveMode(cPIDController::RATE, maxRate);
