...
OI::OI() {
	...
	OpenClawRateButton->WhileHeld(new ClawRate(0.6));
	SmartDashboard::PutData("OpenClawRate", new ClawRate(0.6));
//
	CloseClawRateButton = new JoystickButton(joystick2, 6);
	CloseClawRateButton->WhileHeld(new ClawRate(-0.6));
	//CloseClawRateButton->WhileHeld(new LinearSysRate(Robot::claw,Robot::claw,-0.5));
	SmartDashboard::PutData("CloseClawRate", new ClawRate(-0.6));
//
	...
	SmartDashboard::PutData("ClawOpenFast", new ClawRate(1.0));
	...
	SmartDashboard::PutData("ClawClosedPos", new ClawRate(-1.0));
	...
	MMDriveButton->WhenPressed(new DriveInTelop(cPIDController::DIRECT, 5.0, cPIDController::DIRECT, 20.0));

	PMDriveButton = new JoystickButton(joystick1, 6);
	PMDriveButton->WhenPressed(new DriveInTelop(cPIDController::RATE, 5.0, cPIDController::DIRECT, 20.0));

	MPDriveButton = new JoystickButton(joystick1, 3);
	MPDriveButton->WhenPressed(new DriveInTelop(cPIDController::DIRECT, 5.0, cPIDController::RATE, 20.0));

	PPDriveButton = new JoystickButton(joystick1, 4);
	PPDriveButton->WhenPressed(new DriveInTelop(cPIDController::RATE, 5.0, cPIDController::RATE, 20.0));

	SmartDashboard::PutData("DriveInTelopFast", new DriveInTelop(cPIDController::RATE, 5.0, cPIDController::RATE, 20.0));
	SmartDashboard::PutData("DriveInTelopSlow", new DriveInTelop(cPIDController::RATE, 1.0, cPIDController::RATE, 3.0));
    //float rateIn, float maxTwistIn, double disIn, double tolIn, double angleIn)
	SmartDashboard::PutData("DriveNorthSlow", new DriveForward(1.0, 5.0, 2.0, 0.2, 0.0));
	SmartDashboard::PutData("DriveSouthFast", new DriveForward(5.0, 5.0, 2.0, 0.2, 180.0));
	//double headingIn, float maxTwistIn, float maxRateIn, double tolIn)
	SmartDashboard::PutData("TurnNorthSlow", new DriveToHeading(0.0, 5.0, 2.0, 3.0));
	SmartDashboard::PutData("TurnSouthFast", new DriveToHeading(180.0, 15.0, 5.0, 3.0));
	double angle;
	RobotMap::gyro->Reset();
