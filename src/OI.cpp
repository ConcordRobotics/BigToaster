...
OI::OI() {
	...
	// Claw button controls
		OpenClawButton = new JoystickButton(joystick2, 3);
		OpenClawButton->WhileHeld(new ClawPosition(RobotMap::clawOpenPosition - 0.1));

		CloseClawButton = new JoystickButton(joystick2, 4);
		CloseClawButton->WhileHeld(new ClawPosition(RobotMap::clawClosedPosition + 0.1));
    ...
    SmartDashboard::PutData("ClawOpenRate", new ClawRate(0.2));
    SmartDashboard::PutData("ClawClosedRate", new ClawRate(-0.2));
