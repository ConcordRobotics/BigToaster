...
void RobotMap::init() {
	...
	// Add the gyro and accelerometer
		...
		gyroLimits = new ControllerLimits(-1.0E-30, 1.0E30, -20.0, 20.0, -0.5, 0.5);
		gyroRateGains = new PIDParams(0.1, 0.0, 0.0, 0.5);
		gyroPositionGains = new PIDParams(0.1, 2.0, 0.0, 0.5);
